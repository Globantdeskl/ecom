package com.aeo.checkout.pricing;
...
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT, classes = CheckoutPricingServiceApplication.class)
@ActiveProfiles("test")
class CheckoutPricingServiceApplicationTests {
